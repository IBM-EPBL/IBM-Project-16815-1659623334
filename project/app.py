...
src_path =r'C:\Users\manik\Desktop\yolo_structure\yolo_structure-master\2_Training\src'
print(src_path)
utils_path = r'C:\Users\manik\Desktop\yolo_structure\yolo_structure-master\Utils'
print(utils_path)
...
def afterreg():
    ...
    if(len(docs.all())==0):
        ...
        return render_template('register.html', pred="Registration Successful, please Sign In using your details")
    else:
        return render_template('register.html', pred="You are already a member, please Sign In using your details")
...
@app.route('/afterSign In',methods=['POST'])
def afterSign In():
