...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        ...
        file_id = sys.argv[1]
        os.chdir(r'E:\\IBM\\yolo_structure-master\\Data\\Model_Weights')
        # DESTINATION FILE ON YOUR DISK
        destination = os.path.join(os.getcwd(), sys.argv[2])
        download_file_from_google_drive(file_id, 'E:\\IBM\\yolo_structure-master\\Data\\Model_Weights\\Houses/trained_weights_final.h5')
